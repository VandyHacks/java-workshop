...
public abstract class Ship {
    ...
    /**
     * Moves based on a ships speed property, if remain moves are used up, future moves will be
     * voided until the start of the next turn
     *
    ...
    /**
     * Number of shots are based on a ships firepower property, if remain shots are used up, future
     * shots will be voided until the start of the next turn
     *
    ...
    /**
     * Each shot takes one hull point if it hits, and ships may fire at multiple targets during
     * their turn
     *
    ...
    /**
     * The ship's speed determines travel distance, and used to decide which ships goes first in a
     * sequential order
     *
    ...
    /**
     * Ships firing range is determined in a squared radius, Ex. radius of 3 applies in up, down,
