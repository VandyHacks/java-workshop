...
public class Arena {
    ...
    void fire(Ship source, int x, int y) {
    ...
    /**
     * @param source Object that is moving
     * @param dir
     */
    ...
    /**
     * This will return a list of enemy ships that the current ship can see (Does not include your
     * own ship)
     *
     * @param source object to reference when looking for nearby enemy ships
